...
function _M.new(config)
  ...
  ngx.log(ngx.WARN, 'my env THREESCALE_IMV_IHOST: ', resty_env.value('THREESCALE_IMV_IHOST'))
  ngx.log(ngx.WARN, 'my env THREESCALE_IMV_METHOD: ', resty_env.value('THREESCALE_IMV_METHOD'))
